...
#   ──────────────────────────────────────────────────────────────────────────
#   blob-anonymous-disabled       azurerm_storage_account                ACTIVE ✓ (re-verifying fix)
#   blob-soft-delete              azurerm_storage_account                ACTIVE ✓ (re-verifying fix)
#   blob-versioning               azurerm_storage_account                ACTIVE ✓ (re-verifying fix)
...
#   file-share-soft-delete        azurerm_storage_account                ACTIVE ✓ (re-verifying fix)
#   smb-aes256-encryption         azurerm_storage_account                ACTIVE ✓ (re-verifying fix)
...
#   trusted-services              azurerm_storage_account + network_rules ACTIVE ✓ (re-verifying fix)
...
# ─────────────────────────────────────────────────────────────────────────────
# ACTIVE -- Storage account resources (all storage-account policies)
# ─────────────────────────────────────────────────────────────────────────────
